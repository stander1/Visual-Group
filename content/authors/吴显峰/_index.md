...
**出版物**
 1.	**Xianfeng Wu**, Xinyi Liu, Junfei Wang, Chongyuan Lai*, Jing Zhou*, Xia Liu*. Point Cloud Classification Based on Transformer. Computers and Electrical Engineering (CAEE). 2022.
 2.	Junfei Wang, Xiong Hui, Gong Yanli, **Xianfeng Wu**, Shun Wang, Chongyuan Lai*. Point Clouds Classification by Dynamic Graph CNN with Transformer. Array. Under review.
 3.	**Xianfeng Wu**, Xinyi Liu, Junfei Wang, Chongyuan Lai*, Jing Zhou*, Xia Liu*. PCCT: Point Cloud Classification Based on Transformer. The 7th International Symposium on Artificial Intelligence and Robotics (ISAIR), 2022, Oral.
 4.	Junfei Wang, Luxin Hu, **Xianfeng Wu**, Chongyuan Lai*, Qian Jia*. Data driven point cloud classification: a review. The 7th International Symposium on Artificial Intelligence and Robotics (ISAIR), 2022, Oral.
 5.	Junfei Wang, Xiong Hui, Gong Yanli, **Xianfeng Wu**, Shun Wang, Chongyuan Lai*. Transformer-based Dynamic Graph CNN for Point Clouds Classification. The 7th International Symposium on Artificial Intelligence and Robotics (ISAIR), 2022, Oral.
